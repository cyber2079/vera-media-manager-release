...
| | |
|---|---|
| <img src="https://cdn.jsdelivr.net/gh/cyber2079/vera-media-manager-release@main/docs-img/docs-shot-03.webp" width="420" alt="视频库卡片：封面、进度与「已看」角标"> | <img src="https://cdn.jsdelivr.net/gh/cyber2079/vera-media-manager-release@main/docs-img/docs-shot-05.webp" width="420" alt="播放中的竖向水墨歌词"> |
| <img src="https://cdn.jsdelivr.net/gh/cyber2079/vera-media-manager-release@main/docs-img/docs-shot-06.webp" width="420" alt="车载大屏播放器皮肤：仪表盘即播放器"> | <img src="https://cdn.jsdelivr.net/gh/cyber2079/vera-media-manager-release@main/docs-img/docs-shot-08.webp" width="420" alt="游戏库：封面卡片与工具栏"> |
| <img src="https://cdn.jsdelivr.net/gh/cyber2079/vera-media-manager-release@main/docs-img/docs-shot-10.webp" width="420" alt="快捷中心：常用文件夹、系统工具与电源"> | <img src="https://cdn.jsdelivr.net/gh/cyber2079/vera-media-manager-release@main/docs-img/docs-shot-12.webp" width="420" alt="小组件同屏：时钟、天气、系统监控等"> |
...
| 格式 | 文件 | 说明 |
|------|------|------|
| **NSIS** | [Vera.Media.Manager_1.0.3_x64-setup.exe](https://github.com/cyber2079/vera-media-manager-release/releases/download/v1.0.3/Vera.Media.Manager_1.0.3_x64-setup.exe) | 推荐 · 安装向导式 |
| **MSI** | [Vera.Media.Manager_1.0.3_x64.msi](https://github.com/cyber2079/vera-media-manager-release/releases/download/v1.0.3/Vera.Media.Manager_1.0.3_x64.msi) | 标准包 · 支持 `msiexec /i ... /qn` 静默部署 |
