...
| 格式 | 文件 | 说明 |
|------|------|------|
| **NSIS** | [Vera.Media.Manager_1.0.4_x64-setup.exe](https://github.com/cyber2079/vera-media-manager-release/releases/download/v1.0.4/Vera.Media.Manager_1.0.4_x64-setup.exe) | 推荐 · 安装向导式 |
| **MSI** | [Vera.Media.Manager_1.0.4_x64.msi](https://github.com/cyber2079/vera-media-manager-release/releases/download/v1.0.4/Vera.Media.Manager_1.0.4_x64.msi) | 标准包 · 支持 `msiexec /i ... /qn` 静默部署 |
