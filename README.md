...
- **一个应用，接管全部娱乐**——视频、音乐、图片、游戏、文件管理不再散落在五六个软件里，GPU 硬解、NAS 直连、外接播放器随叫随到
- **会讲故事的主题**——不只是换皮肤：每个主题自带专属特效、音效与背景音乐，整台桌面一起入戏
- **活的桌面**——静态 / 视频 / 轮播 / 天气 / 3D 场景五种壁纸模式，时钟、天气、照片、视频等桌面组件自由拼装
- **本地优先**——数据全部留在你的机器上，备份导入导出完全自主
